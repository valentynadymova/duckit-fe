'use client';
import styles from './OurServicesDesktop.module.css';
    ...
    <section className={styles.ourservices_section}>
      <Container className={styles.ourservices_container}>
        <div className={styles.ourservices_wrap_general}>
          <div className={styles.ourservices_wrap_subtitle}>
            <p
            ...
            <div className={styles.ourservices_wrap}>
              ...
              <p className={styles.ourservices_text}>
                Our team is here to help you figure out the best solution for
                your business. Get in touch with us for personalized assistance
